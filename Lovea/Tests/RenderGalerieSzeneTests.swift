...
final class RenderGalerieSzeneTests: XCTestCase {
    ...
    func testSzenen() {
        var zellen: [Zelle] = [
            ...
            (titel: "Gym Ahmed", ansicht: kopf(.gym, .ahmed, zimmer: Zimmer(ort: .gym))),
            (titel: "Gym Annika eingerichtet", ansicht: kopf(.gym, .annika, zimmer: Zimmer(deko: ["pflanze", "lautsprecher"], poster: 11))),
